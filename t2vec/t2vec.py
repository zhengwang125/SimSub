...
#path = 'C:\\Users\\WANG_ZHENG\\Downloads\\t2vec-master\\'
path = 'C:\\Users\\WANG_ZHENG\\Downloads\\t2vec-master\\data\\porto\\'
#path = './data/porto/'
parser = argparse.ArgumentParser(description="train.py")

parser.add_argument("-data", default=path+"experiment",
    help="Path to training and validating data")

parser.add_argument("-checkpoint", default=path+"best_model.pt",
...
parser.add_argument("-t2vec_batch", type=int, default=1000,
...
parser.add_argument("-seq_reverse", type=bool, default=False,
    help="Reversing the input sequence")

parser.add_argument("-io_by_disk", type=bool, default=False,
    help="IO by disk or cache")
